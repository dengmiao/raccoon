...
import com.cure.core.config.security.sms.SmsAuthenticationFilter;
...
/**
 * @title: SmsLoginConfigurer
 * @description: 短信登录配置器
 * @author: dengmiao
 * @create: 2019-05-24 09:39
 **/
public class SmsLoginConfigurer extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {

    private static final String SMS_DEFAULT_LOGIN_PROCESS_URL = "/authentication/mobile";
